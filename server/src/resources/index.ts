...
export function registerResources(server: McpServer, assets: { CSS: string; JS_FLIGHT_DASHBOARD: string; JS_FLIGHT_DETAIL: string; JS_CAR_DETAIL: string; JS_CAR_DASHBOARD: string; }) {
  ...
  registerFlightDashboardWidgetResource(server, assets.JS_CAR_DASHBOARD, assets.CSS);
}
