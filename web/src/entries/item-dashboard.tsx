      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex items-center gap-5">
          ...
          <div className="bg-white/10 p-4 rounded-2xl backdrop-blur-xl border border-white/20 shadow-inner">
            <IconHeader className="w-8 h-8 text-[var(--color-accent)]" />
          </div>
              ...
              <div className="absolute top-4 left-4 flex flex-col gap-2">
                {item.visibleTags.map((tag) => (
                  <Badge
                    key={tag}
                    color="dark"
                    className="bg-black/70 text-white border-0 font-black uppercase px-3 backdrop-blur-md"
                  >
                    {tag}
                  </Badge>
                ))}
          ...
          <div className="flex flex-col flex-grow p-6">
            <h3
              className={`
                ...
                transition-colors
                mb-2
                ${category.toLowerCase().includes("looks") ? "text-center" : ""}
            ...
            {config.showPrice && (
              <div className="mt-auto pt-5 border-t border-token-border-light flex items-center justify-between">
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center gap-1 text-2xl font-black leading-none text-[var(--color-accent)]">
