        ...
        <div className="absolute -top-2 -right-2 z-50">
          <Tooltip content={isFullscreen ? "Minimizar" : "Pantalla Completa"}>
            <button 
              ...
              className="bg-token-main-surface-tertiary text-token-text-primary p-3 rounded-full shadow-2xl border border-token-border-medium hover:scale-110 transition-transform"
            >
