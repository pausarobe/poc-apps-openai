      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <Card className="bg-token-main-surface-secondary border-t-8 border-blue-600 border-x-token-border-medium border-b-token-border-medium shadow-2xl rounded-3xl overflow-hidden">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6 p-2">
            <div className="flex items-center gap-4">
              <div className="bg-blue-600 p-4 rounded-2xl text-white shadow-lg animate-pulse shrink-0">
                <HiLightningBolt className="w-8 h-8" />
              </div>
              <div>
                <h1 className="text-2xl font-black text-token-text-primary tracking-tight leading-tight">{car.name}</h1>
            ...
            <div className="text-center sm:text-right bg-token-main-surface-tertiary p-5 rounded-3xl border border-token-border-light shadow-sm min-w-[180px] w-full sm:w-auto">
              <p className="text-[10px] text-blue-500 uppercase font-bold tracking-widest mb-1">Cuota Renting</p>
              <p className="text-4xl font-black text-blue-700">{Math.round(Number(data.cuota))}€<small className="text-sm font-normal">/mes</small></p>
            </div>
          </div>
        </Card>
        ...
        <div className="flex flex-col gap-6">
          ...
          <Card className="shadow-xl border-token-border-medium rounded-[2.5rem] p-6 bg-token-main-surface-secondary flex flex-col justify-between">
              ...
              <div className="overflow-hidden rounded-2xl border border-token-border-light shadow-sm">
                <table className="w-full text-left border-collapse">
                  <tbody className="divide-y divide-token-border-light">
                    <tr className="bg-token-main-surface-secondary hover:bg-token-main-surface-tertiary transition-colors font-medium">
                      <td className="px-6 py-5 text-token-text-tertiary text-lg">Uso Anual</td>
                    ...
                    <tr className="bg-token-main-surface-tertiary/30 hover:bg-token-main-surface-tertiary transition-colors">
                      <td className="px-6 py-5 text-token-text-tertiary font-medium text-lg">Seguro</td>
                    ...
                    <tr className="bg-token-main-surface-secondary hover:bg-token-main-surface-tertiary transition-colors">
                      <td className="px-6 py-5 text-token-text-tertiary font-medium text-lg">Mantenimiento</td>
                      <td className="px-6 py-5 text-right font-black text-token-text-primary text-xl">{Math.round(Number(data.mantenimiento))}€</td>
                    </tr>
                    <tr className="bg-token-main-surface-tertiary/30 hover:bg-token-main-surface-tertiary transition-colors">
                      <td className="px-6 py-5 text-token-text-tertiary font-medium text-lg">Reparaciones</td>
            ...
            <div className="mt-10">
              <Button size="xl" gradientDuoTone="purpleToBlue" className="w-full shadow-2xl font-black tracking-widest uppercase py-5 rounded-[1.5rem] text-xl transform hover:scale-[1.01] transition-all">
                Confirmar Selección
              </Button>
            </div>
          </Card>
